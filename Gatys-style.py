...
pretrained_net.load_state_dict(torch.load('/data/ckpt/zhanghaozhuo/Style Transfer/vgg19-dcbb9e9d.pth'))
...
def train(X, contents_Y, styles_Y, device, lr, num_epochs, lr_decay_epoch):
    ...
    for epoch in range(num_epochs):
        ...
        tl = float(tv_l)
        results = open('/data/ckpt/zhanghaozhuo/Style Transfer/Gatys-style-logs.txt',"a")
        ...
        if (epoch+1)%50 == 0:
            ...
            img = postprocess(X)
            torchvision.utils.save_image(img, f'/data/ckpt/zhanghaozhuo/Style Transfer/Gatys-style-outputs/epoch_{epoch + 1}.jpg')    
